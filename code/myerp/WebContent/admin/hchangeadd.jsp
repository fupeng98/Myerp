...
<!-- <div id="box1">
	<select name="mygrade" v-model="tuihuan">
...
<p class="path">当前位置：名典潮鞋进销存管理系统/退换货管理/商品<%=request.getParameter("t").equals("1")?"入库":"出库" %> </p>
<form action="../changeadd" method="post">
...
<table border="0" cellspacing="0" cellpadding="0" class="tb">
	...
	<tr><td class="lable"><%=request.getParameter("t").equals("1")?"退货":"换货" %>前数量</td><td><input type="text" name="tbprooldcount" id="tbprooldcount"/></td></tr>
	<tr><td class="lable"><%=request.getParameter("t").equals("1")?"退货":"换货" %>数量</td><td><input type="text" name="tbprocount" id="tbprocount"/></td></tr>

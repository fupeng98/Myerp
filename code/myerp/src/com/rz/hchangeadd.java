 ...
 */
@WebServlet("/hchangeadd")
public class hchangeadd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				response.getWriter().write("<font color='green'>退换成功！</font>");
				response.setHeader("Refresh", "3;URL="+request.getContextPath()+"/admin/hchangeadd.jsp?t="+t);	
	}
